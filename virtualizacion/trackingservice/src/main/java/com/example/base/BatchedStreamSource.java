...
public class BatchedStreamSource extends StreamSource {
    ...
    public BatchedStreamSource(String content, KinesisConnectorConfiguration config, String inputFile) {
        this(content,config, inputFile, false);
    }

    public BatchedStreamSource(String content, KinesisConnectorConfiguration config, String inputFile, boolean loopOverStreamSource) {
        super(content, config, inputFile, loopOverStreamSource);
