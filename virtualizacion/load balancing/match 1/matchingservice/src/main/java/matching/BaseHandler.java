...
public class BaseHandler {
    //private static String DB_URL = "jdbc:mysql://52.207.248.224:9306?useUnicode=yes&characterEncoding=UTF-8";
    private static String DB_URL = "jdbc:mysql://172.31.48.22:9306?useUnicode=yes&characterEncoding=UTF-8";
